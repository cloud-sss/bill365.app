...
async def add_items(add_item:AddItem):
    ...
    if cursor.rowcount>0:
        ...
        query1 = f"INSERT INTO md_item_rate (item_id, price, sale_price,purchase_price, discount, cgst, sgst, created_by, created_dt, sp_gst_flag,pp_gst_flag,disc_prtg_flag) VALUES ({cursor.lastrowid}, {add_item.price},{add_item.sale_price}, {add_item.purchase_price}, {add_item.discount}, {add_item.cgst}, {add_item.sgst}, '{add_item.created_by}', '{formatted_dt}','{add_item.sp_gst_flag}','{add_item.pp_gst_flag}','{add_item.disc_prtg_flag}')"
