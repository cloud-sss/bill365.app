...
async def edit_general_settings(rcp_set:GeneralSettings):
    ...
    conn = connect()
    cursor = conn.cursor()
    query = f"UPDATE md_receipt_settings SET rcv_cash_flag='{rcp_set.rcv_cash_flag}', custom_sl_flag='{rcp_set.custom_sl_flag}', rcpt_type='{rcp_set.rcpt_type}', unit_flag='{rcp_set.unit_flag}', cust_inf='{rcp_set.cust_inf}', pay_mode='{rcp_set.pay_mode}', stock_flag='{rcp_set.stock_flag}', price_type='{rcp_set.price_type}', refund_days='{rcp_set.refund_days}', kot_flag='{rcp_set.kot_flag}', modified_by='{rcp_set.modified_by}', modified_at='{formatted_dt}',stock_alert_flag='{rcp_set.stock_alert_flag}', stock_alert_prtg='{rcp_set.stock_alert_prtg}'WHERE comp_id={rcp_set.comp_id}"
    cursor.execute(query)
    conn.commit()
    conn.close()
    cursor.close()
