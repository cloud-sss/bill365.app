...
function BottomNavigationPaper() {
 ...
 useEffect(() => {
  ...
  //   });
  //   return unsubscribe;
  console.log("Setting up FCM listener in BottomNavigationPaper",messaging());
  messaging().onMessage((remoteMessage) => {
    console.log('FCM Message Data in BottomNavigationPaper:', JSON.stringify(remoteMessage));
  });
  }, [currentRoute]);
  return (
    <Tab.Navigator
