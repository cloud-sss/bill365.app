...
function CategoriesScreen() {
    ...
    const {loading, categories, handleGetCategories } = useContext<AppStoreContext>(AppStore)
    ...
    return (
        <SafeAreaView
            ...
            <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={{
                ...
                {loading ? <ActivityIndicator animating={true} color={'green'} style={{ marginTop: 20 }} size={'large'} /> : null}
                {categories.length !== 0
                    ...
                    :categories.length !== 0 && !loading && <SurfacePaper
                        borderRadiusEnabled
