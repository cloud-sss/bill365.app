...
function ReportForm3({ title, onPress, flag, shops }) {
  console.log(url);
   ...
   const validationSchema = Yup.object({
     ...
     to_dt: Yup.string().required("Date is required"),
     shops: Yup.string().required("Outlet is required"),
   });
               ...
               <div className="w-full">
                ...
                <div className="w-full">
                 ...
                 {formik.errors.to_dt && formik.touched.to_dt ? (
                   <div className="text-red-500 text-sm">{formik.errors.to_dt}</div>
                 ) : null}
               </div>
               </>
             )}
